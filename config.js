...
const baseConfig = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '919356730236-1632403322@g.us',
    ...
    RG: process.env.RG || '919356730236-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'CYBER-MD;RAHUL-MASTER;default',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.NOT_ALLOWED || '852',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "CYBER-MD",
    BOT_NAME: process.env.BOT_NAME || 'CYBER-MD',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭RAHUL-MASTER¹¹ꫂ;CYBER MD bot;https://i.ibb.co/s92pZRQ4/temp.jpg' : process.env.AUDIO_DATA,
    ...
    SUDO: process.env.SUDO || "919356730226",
